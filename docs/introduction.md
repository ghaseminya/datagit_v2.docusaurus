...
description: قبل از شروع کد نویسی، باید برای خودتون هدف تعیین کنید و مشخص کنید که چه مهارت هایی میخواید یاد بگیرید. اصلا چرا میخواید برنامه نویسی کنید؟ میتونه دلیل های مختلفی داشته باشه مثل صرفا یادگیری، آمادگی برای امتحان دانشگاه، ساخت نرم افزار، آنالیز داده یا کلی دلیل دیگه!
keywords:
  - اموزش برنامه نویسی
